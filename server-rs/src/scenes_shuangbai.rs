...
pub static SHUANGBAI_SCENES: &[SceneDef] = &[
    ...
    SceneDef {
        id: "sb_01",
        bg: Some("img_shuangbai_well.png"),
        loc: Some("枯井井沿"),
        mood: "mystery",
        speaker: None,
        voice: None,
    ...
    SceneDef {
        id: "sb_02",
        bg: Some("img_shuangbai_deep.png"),
        loc: Some("井道（下沉中）"),
        mood: "danger",
        speaker: None,
        voice: None,
    ...
    SceneDef {
        id: "sb_04",
        bg: Some("img_shuangbai_barn.png"),
        loc: Some("谷仓门口"),
        mood: "mystery",
        speaker: None,
        voice: None,
    ...
    SceneDef {
        id: "sb_07",
        bg: Some("img_shuangbai_barn_open.png"),
        loc: Some("谷仓内"),
        mood: "danger",
        speaker: Some("复苏者·旧温"),
        voice: None,
    ...
    SceneDef {
        id: "sb_12",
        bg: Some("img_shuangbai_bones.png"),
        loc: Some("井底白骨坪"),
        mood: "danger",
        speaker: None,
        voice: None,
    ...
    SceneDef {
        id: "sb_boss_round",
        bg: Some("img_shuangbai_boss.png"),
        loc: Some("井底白骨坪"),
        mood: "danger",
        speaker: Some("首位复苏者"),
        voice: None,
    ...
    SceneDef {
        id: "sb_settle",
        bg: Some("img_shuangbai_morning.png"),
        loc: Some("井口（雾散）"),
        mood: "awe",
        speaker: None,
        voice: None,
    ...
    SceneDef {
        id: "sb_death",
        bg: Some("img_shuangbai_death.png"),
        loc: Some("灰雾深处"),
        mood: "danger",
        speaker: None,
        voice: None,
    ...
    SceneDef {
        id: "sb_hub",
        bg: Some("img_shuangbai_misty.png"),
        loc: Some("霜白村村道"),
        mood: "mystery",
        speaker: None,
        voice: None,
